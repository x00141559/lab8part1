...
class Routes(
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_addProductSubmit5_route = Route("GET",
  ...
  // @LINE:12
  private[this] lazy val controllers_HomeController_addCustomer6_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addCustomer")))
  )
  private[this] lazy val controllers_HomeController_addCustomer6_invoker = createInvoker(
  ...
  // @LINE:13
  private[this] lazy val controllers_HomeController_addCustomerSubmit7_route = Route("GET",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:12
    case controllers_HomeController_addCustomer6_route(params@_) =>
      call { 
        controllers_HomeController_addCustomer6_invoker.call(HomeController_0.addCustomer)
      }
